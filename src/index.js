...
const divMelon = require('./katas/watermelon')
const ncn = require('./katas/non-consec-num')
const stringSplitter = require('./katas/string-splitter')
const digPow = require('./katas/dig-pow')